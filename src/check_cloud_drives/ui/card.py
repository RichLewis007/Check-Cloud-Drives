...
from PySide6.QtCore import Qt, QMimeData, QPoint, QTimer, QPropertyAnimation, QEasingCurve, Property
from PySide6.QtGui import QDrag, QPainter, QPixmap, QTransform, QColor, QPen
...
class DriveCard(QFrame):
    ...
    def __init__(self, drive_config: DriveConfig, parent=None):
        ...
        self.drive_status: Optional[DriveStatus] = None
        self.is_updating = False
        self.drag_start_position = QPoint()
        self.setAcceptDrops(True)  # Enable drop events
        self.last_updated_str: Optional[str] = None  # Store last updated timestamp string
    ...
    def _setup_ui(self):
        ...
        self.status_label.setStyleSheet("color: #7f8c8d; font-size: 13px; font-family: 'AtkynsonMono Nerd Font Propo', monospace;")
        layout.addWidget(self.status_label)
        
        # Drive info
        self.info_label = QLabel("Click 'Refresh All' to update")
        self.info_label.setStyleSheet("color: #5a6c7d; font-size: 11px; font-family: 'AtkynsonMono Nerd Font Propo', monospace;")
        ...
        self.update_indicator.setToolTip("Update status indicator - shows when drive is being refreshed")
    ...
    def update_status(self, status: DriveStatus):
        ...
        if status.error:
            ...
            self.status_label.setStyleSheet("color: #e74c3c; font-size: 13px; font-weight: bold; font-family: 'AtkynsonMono Nerd Font Propo', monospace;")
            ...
            self.status_label.setStyleSheet("color: #27ae60; font-size: 13px; font-weight: bold; font-family: 'AtkynsonMono Nerd Font Propo', monospace;")
    ...
    def set_updating(self, is_updating: bool):
        ...
        if is_updating:
            ...
            self.status_label.setStyleSheet("color: #f39c12; font-size: 13px; font-weight: bold; font-family: 'AtkynsonMono Nerd Font Propo', monospace;")
